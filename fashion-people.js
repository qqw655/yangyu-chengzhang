/* 洋芋养成 · 身材相似博主（国内外）· 按类型分区 + 区内按粉丝/点赞排序
   分类：athletic 运动街头 / casual 休闲 / daily 日常通勤 / japanese 日系 / korean 韩系 / minimal 极简质感 / formal 高端正式 / allround 全能型
   sortKey：粉丝数优先、无粉丝数用获赞/赞藏作代理；数据来自各平台公开主页/百科/数据站，真实有出处 */
const FASHION_CATS=[
  { key:'athletic', name:'运动街头', desc:'和你"大而好用"的身材最配，显高显壮不臃肿' },
  { key:'casual', name:'休闲', desc:'舒服但不松垮，日常出门随手就能抄' },
  { key:'daily', name:'日常通勤', desc:'学生党到上班族全覆盖，每天都能用' },
  { key:'japanese', name:'日系', desc:'宽松叠穿、盐系 cityboy、简约日式美学' },
  { key:'korean', name:'韩系', desc:'干净少年感、极简日常、冷淡学院风' },
  { key:'minimal', name:'极简质感', desc:'少而精，靠版型和颜色撑起高级感' },
  { key:'formal', name:'高端正式', desc:'西装/定制/职场进阶专用' },
  { key:'allround', name:'全能型', desc:'日常、正式、运动都能穿，一衣多穿的代表' },
];
const FASHION_PEOPLE=[
  /* ===== 运动街头 ===== */
  {
    cat:'athletic', sortKey:684000,
    name:'JY小嗨（JYSINOJ）',
    platform:'小红书',
  ...
  /* ===== 日系 ===== */
  {
    cat:'japanese', sortKey:470000,
    name:'Ryo Takashima（高島涼）',
    platform:'Instagram',
    link:'https://www.instagram.com/ryo__takashima/',
    linkLabel:'主页（Instagram）',
    stats:'IG 47 万粉（famousbirthdays 公开数据）',
    body:'约170cm（本人自称"身高不高男生范本"）· 日系穿搭天花板',
    style:'日式极简 + cityboy + gorpcore：宽松剪裁、低饱和色、靠叠穿出层次',
    tips:[
      '版型全选宽松基础款，剪裁利落有立体感，不靠 logo 撑场面',
      '叠穿是灵魂：衬衫/马甲/卫衣一层层加，线条感自然显高',
      '颜色以黑白灰 + 卡其/棕/蓝为主，同色系深浅过渡最稳',
    ],
    outfits:[
      {t:'宽松白衬衫 + 针织马甲 + 直筒工装裤',d:'衬衫微落肩、马甲卡其色、工装裤直筒微堆，帆布鞋收尾。日系叠穿公式，增高又显瘦。',link:'https://www.instagram.com/ryo__takashima/',linkLabel:'看主页' },
      {t:'黑色高领 + 宽松西装 + 阔腿裤 + 运动鞋',d:'高领打底 + 西装不系扣 + 阔腿裤垂坠，cityboy 街头感，约会/拍照都能用。',link:'https://www.instagram.com/ryo__takashima/',linkLabel:'看主页' },
    ],
  },
  {
    cat:'japanese', sortKey:200000,
    name:'水曜日定休',
    platform:'抖音',
    link:'https://baike.baidu.com/item/%E6%B0%B4%E6%9B%9C%E6%97%A5%E5%AE%9A%E4%BC%91',
    linkLabel:'资料页（百度百科）',
    stats:'抖音 20 万粉（2025-04 公开数据）',
    body:'广州男装主理人，简约日式美学向',
    style:'简约日式：干净配色 + 松弛版型，广州气候友好',
    tips:[
      '风格关键词"简约日式美学"：颜色克制、版型松弛、质感优先',
      '用亚麻/棉这类面料撑质感，比图案更重要',
      '裤装选直筒/微宽，上衣肩线合身不紧绷',
    ],
    outfits:[
      {t:'亚麻衬衫 + 九分直筒裤 + 德训鞋',d:'亚麻衬衫透气微皱、九分裤露脚踝、德训 2-3cm。日式清爽感，广东夏天通勤最舒服。',link:'https://www.douyin.com/search/%E6%B0%B4%E6%9B%9C%E6%97%A5%E5%AE%9A%E4%BC%91',linkLabel:'看视频' },
      {t:'长款衬衫 + 白 T + 宽腿裤',d:'长衬衫敞开当第二层，内搭白 T；宽腿裤微垂。日系松弛叠穿，显高不压人。',link:'https://www.douyin.com/search/%E6%B0%B4%E6%9B%9C%E6%97%A5%E5%AE%9A%E4%BC%91',linkLabel:'看视频' },
    ],
  },
  {
    cat:'japanese', sortKey:0,
    name:'YUSEI（ys__ebifly）',
    platform:'Instagram / 小红书',
    link:'https://www.instagram.com/ys__ebifly/',
    linkLabel:'主页（Instagram）',
    stats:'178cm（小红书推荐：盐系 cityboy）',
    body:'178cm / 日韩混血，和你身高几乎一致',
    style:'盐系 cityboy：古着 + 宽松叠穿 + 少年感',
    tips:[
      '爱逛古着，单品有故事感：旧衬衫、工装、做旧牛仔',
      '盐系秘诀=颜色淡 + 版型松 + 表情自然，不刻意',
      '配饰少而准：帽子、帆布包、银饰做小面积点缀',
    ],
    outfits:[
      {t:'古着衬衫 + 工装裤 + 帆布鞋',d:'衬衫选浅色微旧感、工装裤直筒、帆布鞋 2cm。日系盐系少年，校园/日常通用。',link:'https://www.xiaohongshu.com/discovery/item/68eb353a000000000302e58c',linkLabel:'看推荐' },
      {t:'针织背心 + 白 T + 直筒裤',d:'针织背心叠白 T 露领口和袖口，直筒裤腰 76。日系叠穿最不出错的一套。',link:'https://www.instagram.com/ys__ebifly/',linkLabel:'看主页' },
    ],
  },
  {
    cat:'japanese', sortKey:0,
    ...
    linkLabel:'推荐视频（抖音）',
    stats:'粉丝见主页',
    body:'170-175cm 日系休闲参考（阳光少年感）',
    style:'潮流实用主义：线条感单品 + 日系休闲',
    tips:[
      '坚持"潮流实用主义"：好看的必须能日常穿，不买摆设',
      '擅长用线条感强的单品：直筒裤、利落外套，拉直身形',
      '30 岁依然少年感：颜色清爽、版型合身、不堆 logo',
    ],
    outfits:[
      {t:'条纹 T + 直筒裤 + 帆布鞋',d:'线条感单品代表：条纹 T 显轮廓，直筒裤拉直腿型，帆布鞋收尾。日系休闲基础公式。',link:'https://www.douyin.com/note/7457866088576077093',linkLabel:'看视频' },
      {t:'短外套 + 白 T + 束脚裤 + 板鞋',d:'短外套盖臀一半、白 T 打底、束脚裤配板鞋 2.5cm。利落不拖沓，少年感满满。',link:'https://www.douyin.com/note/7457866088576077093',linkLabel:'看视频' },
    ],
  },
  /* ===== 韩系 ===== */
  {
    cat:'korean', sortKey:0,
    name:'siiiido',
    platform:'Instagram / 小红书',
    link:'https://www.xiaohongshu.com/discovery/item/606bca6f00000000210350b1',
    linkLabel:'推荐帖（小红书）',
    stats:'韩国极简日常（粉丝见主页）',
    body:'韩国博主，极简日常风，不挑身材',
    style:'韩系极简：颜色少、版型顺、谁穿都像换了个人',
    tips:[
      '风格以极简日常为主，色系很少，非常不挑人不挑身材',
      '上衣裤子都选柔顺垂坠的版型，线条干净',
      '黑白灰米打底，一套只留一个重点',
    ],
    outfits:[
      {t:'燕麦针织 + 直筒西裤 + 乐福鞋',d:'燕麦色针织贴肤但不紧、直筒西裤垂坠、乐福 2cm。韩系极简日常，通勤约会两用。',link:'https://www.instagram.com/siiiido/',linkLabel:'看主页' },
      {t:'白衬衫 + 阔腿西裤 + 小白鞋',d:'衬衫微宽松、阔腿裤垂坠、白鞋收尾。干净利落，夏天最凉快的高级感。',link:'https://www.instagram.com/siiiido/',linkLabel:'看主页' },
    ],
  },
  {
    cat:'korean', sortKey:0,
    name:'185mg_',
    platform:'Instagram',
    link:'https://www.zhihu.com/question/537953820/answer/2596495215',
    linkLabel:'推荐帖（知乎）',
    stats:'韩国 Ins 男装博主（粉丝见主页）',
    body:'瘦高少年感向，适合练成后的你',
    style:'韩系夏季休闲：低调舒服，减龄不幼稚',
    tips:[
      '夏季公式=浅色上装 + 直筒/九分裤 + 小白鞋，舒服低调',
      '适合瘦瘦高高有少年感的男生，练壮后上身更撑得住',
      '全身保持一个低饱和色系，干净是第一位',
    ],
    outfits:[
      {t:'浅蓝衬衫 + 白 T + 九分裤',d:'衬衫敞开当外套、白 T 打底、九分裤露脚踝、白鞋 2.5cm。韩系少年感夏季公式。',link:'https://www.instagram.com/185mg_/',linkLabel:'看主页' },
      {t:'素色 T + 直筒裤 + 板鞋',d:'T 恤选 70cm 衣长微弹、直筒裤腰 76、板鞋 2.5cm。最基础的韩系干净穿搭。',link:'https://www.instagram.com/185mg_/',linkLabel:'看主页' },
    ],
  },
  {
    cat:'korean', sortKey:0,
    ...
    stats:'韩国 Ins 男装博主（粉丝见主页）',
    body:'瘦高少年感向，夏季休闲参考',
    style:'韩系休闲：宽松衬衫、素色叠穿、少年感',
    tips:[
      '和 185mg_ 同属"瘦高少年感"梯队，公式可互相参考',
      '宽松衬衫 + 直筒裤是核心单品，肩线别太垮',
      '鞋选帆布/德训这类低存在感款式，不抢衣服',
    ],
    outfits:[
      {t:'宽松白衬衫 + 卡其直筒裤 + 帆布鞋',d:'衬衫微落肩、卡其裤直筒、帆布鞋 2cm。韩系少年感，日常最高利用率。',link:'https://www.instagram.com/oneonones_/',linkLabel:'看主页' },
      {t:'条纹针织 + 白 T + 直筒牛仔裤',d:'针织内搭白 T 露领口、直筒牛仔腰 76、板鞋收尾。干净减龄，约会通用。',link:'https://www.instagram.com/oneonones_/',linkLabel:'看主页' },
    ],
  },
  /* ===== 极简质感 ===== */
  {
    cat:'minimal', sortKey:2000000,
    name:'Alex Costa',
  ...
  {
    cat:'allround', sortKey:350000,
    name:'Harry Has',
    platform:'YouTube',
    link:'https://www.youtube.com/results?search_query=Harry+Has+menswear',
    linkLabel:'视频入口（YouTube）',
    stats:'YouTube 35 万订阅 · 播放 5000 万+',
    body:'约180cm / 匀称（近似参考），英伦平价穿搭',
